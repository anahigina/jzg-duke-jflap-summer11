...
public class CNFConverter {
	...
	private String getLeft(String right) {
		...
		if (left != null)
			return left;
		leftAdded = true;
		left = grammar.isTerminal(right) ? 
				"B" + PDAToCFGConverter.LEFT_PAREN + right + PDAToCFGConverter.RIGHT_PAREN : 
				"D" + PDAToCFGConverter.LEFT_PAREN + (++numVariables) + PDAToCFGConverter.RIGHT_PAREN;
	...
	private class ProductionDirectory {
		 ...
		 */
		public ProductionDirectory(Grammar grammar) throws IllegalArgumentException{
